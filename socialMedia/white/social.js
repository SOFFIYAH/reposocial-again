...
if(id=="tgii"){
    ...
    document.getElementById("tgiv").style.padding="8px"
        ...
        document.getElementById("inst").style.color="#443F3C" 

        document.getElementById("yt").style.color="#443F3C" 

        document.getElementById("tt").style.color="#443F3C" 
    
        document.getElementById("txt").style.color="#443F3C" 
    
        document.getElementById("twt").style.color="#443F3C" 
    
        document.getElementById("pnt").style.color="#443F3C" 
    
        document.getElementById("lik").style.color="#443F3C" 
    
        document.getElementById("rdt").style.color="#443F3C" 
    
        document.getElementById("eml").style.color="#443F3C" 

        document.getElementById("fb").style.color="#443F3C" 
...
btn.forEach(btn => {
    ...
    document.getElementById("inst").style.color="#B0F3D4" 

        document.getElementById("yt").style.color="#B0F3D4" 

        document.getElementById("tt").style.color="#B0F3D4" 
    
        document.getElementById("txt").style.color="#B0F3D4" 
    
        document.getElementById("twt").style.color="#B0F3D4" 
    
        document.getElementById("pnt").style.color="#B0F3D4" 
    
        document.getElementById("lik").style.color="#B0F3D4" 
    
        document.getElementById("rdt").style.color="#B0F3D4" 
    
        document.getElementById("eml").style.color="#B0F3D4" 

        document.getElementById("fb").style.color="#B0F3D4" 
...
btn.forEach(btn => {
    ...
    document.getElementById("inst").style.color="#FFE3B3" 

        document.getElementById("yt").style.color="#FFE3B3" 

        document.getElementById("tt").style.color="#FFE3B3" 
    
        document.getElementById("txt").style.color="#FFE3B3" 
    
        document.getElementById("twt").style.color="#FFE3B3" 
    
        document.getElementById("pnt").style.color="#FFE3B3" 
    
        document.getElementById("lik").style.color="#FFE3B3" 
    
        document.getElementById("rdt").style.color="#FFE3B3" 
    
        document.getElementById("eml").style.color="#FFE3B3" 

        document.getElementById("fb").style.color="#FFE3B3" 
...
btn.forEach(btn => {
    ...
    document.getElementById("inst").style.color="#35CEC9" 

    document.getElementById("yt").style.color="#35CEC9" 

    document.getElementById("tt").style.color="#35CEC9" 

    document.getElementById("txt").style.color="#35CEC9" 

    document.getElementById("twt").style.color="#35CEC9" 

    document.getElementById("pnt").style.color="#35CEC9" 

    document.getElementById("lik").style.color="#35CEC9" 

    document.getElementById("rdt").style.color="#35CEC9" 

    document.getElementById("eml").style.color="#35CEC9" 

    document.getElementById("fb").style.color="#35CEC9" 
